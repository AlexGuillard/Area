...
export class DiscordService {
  ...
  async discordLogin(@Res() req: any) {
    const url =
      'https://discord.com/api/oauth2/authorize?client_id=1189230397108793416&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2Fauth%2Fdiscord%2Fcallback&scope=identify+email';
    req.redirect(url);
  }
