    ...
    super(
      {
        ...
        scope:
          'user-read-private user-read-email playlist-modify-private playlist-read-collaborative playlist-read-private playlist-modify-public user-read-playback-state user-follow-modify user-follow-read',
      },
      (
        accessToken: string,
        refreshToken: string,
